            ...
            <ScrollReveal delay={0.4}>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
                {highlights.map((item, index) => (
                  <motion.div
                    key={item.title}
                    className="p-4 bg-slate-800/30 rounded-xl border border-slate-700/50 hover:border-blue-500/50 transition-all group text-center"
                  ...
                  >
                    <item.icon className="w-8 h-8 text-blue-400 mb-3 mx-auto group-hover:text-purple-400 transition-colors" />
